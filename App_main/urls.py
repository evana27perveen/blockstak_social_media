...
from .views import (
    ProfileViewSet,
    ConnectionListCreateView, PostListView, PostCreateView, PostDetailView, CommentListView, CommentCreateView, LikeListView,
...
urlpatterns = [
    ...
    path('connections/<int:pk>/', ConnectionListCreateView.as_view(), name='connection-detail'),
]
